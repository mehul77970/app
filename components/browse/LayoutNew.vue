...
const { item, background, logo, defaultSources, videoSources, audioSources, subtitleSources } = defineProps<{
  item: BaseItemDto
  background: string
  logo: string
  defaultSources?: { video: VideoSource | null, audio: AudioSource | null, subtitle: SubtitleSource | null }
...
<template>
  <div class="w-full">
    <div class="flex flex-col justify-center items-start min-h-[100vh] w-full mt-[128px]">
        ...
        >
          ...
          <div class="inline-flex flex-col justify-start items-start gap-1 text-[1rem]">
            ...
            >
              ...
              <Select :default-value="defaultSources.video.source.Index?.toString() || '0'">
            ...
            >
              ...
              <Select :default-value="defaultSources.audio.source.Index?.toString() || '0'">
                <SelectTrigger class="flex-grow-1">
                  <SelectValue :placeholder="defaultSources.video?.title" />
                </SelectTrigger>
                <SelectContent>
            ...
            >
              ...
              <Select :default-value="defaultSources.subtitle.source?.Index?.toString() || '0'">
                <SelectTrigger class="flex-grow-1">
