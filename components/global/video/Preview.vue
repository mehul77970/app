  ...
  >
    ...
    >
      <Transition name="fade">
        <img
          v-if="!playing"
          :src="useServerImage(item, { type: 'Thumb' })"
      ...
      <Transition name="fade">
        ...
        >
          <Button v-model="muted"> Toggle Mute </Button>
        </div>
      </Transition>
        ...
        >
          <div class="inline-flex justify-between items-end flex-wrap">
            <div class="inline-flex flex-col gap-1 w-full">
              ...
              >
                <span v-if="!episode" class="font-semibold">{{
                  item.SeriesName
                }}</span>
                ...
                <span v-if="!episode" class="text-white/75">{{
                  item.SeasonName
                }}</span>
              </div>
              ...
              <div class="name inline-flex gap-2 justify-between items-center">
                ...
                <span v-if="showProgress" class="text-white/75 text-sm ml-auto"
      ...
      <Transition name="fade">
        ...
        >
          <PhCloudX weight="fill" :size="72" class="" />
