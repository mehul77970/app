...
async function createAssPlayer(resample: ResampleConfig = 'video_width') {
  const ASSSubs = (await import('assjs')).default

  assPlayer = new ASSSubs(
    assText,
