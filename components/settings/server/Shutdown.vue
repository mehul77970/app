    ...
    <AlertDialogContent>
      <AlertDialogHeader>
        ...
        <AlertDialogDescription>
          ...
          <Alert v-if="loading" class="w-full mt-4">
            <AlertTitle class="font-semibold">
              Shutting down Jellyfin Server...
            </AlertTitle>
          </Alert>
          <Alert v-if="error" variant="destructive" class="w-full mt-4">
          ...
          <Alert v-if="shutdownState" variant="destructive" class="w-full mt-4">
            <AlertTitle>
      ...
      <AlertDialogFooter>
        ...
        <Button variant="destructive" :disabled="loading" @click="shutdown">
          <span v-if="!loading">Shutdown</span>
          <PhCircleNotch v-else :size="24" class="animate-spin" />
        </Button>
      </AlertDialogFooter>
    </AlertDialogContent>
  </AlertDialog>
