    ...
    <AlertDialogContent>
      <AlertDialogHeader>
        ...
        <AlertDialogDescription>
          Shutting down will cause all clients to become unresponsive, and you will be unable to communicate with the server<br>
          <Alert
            v-if="loading"
            class="w-full mt-4"
          >
          ...
          <Alert
            ...
            class="w-full mt-4"
          >
            <AlertTitle>Jellyfin Server has been succesfully shutdown</AlertTitle>
          </Alert>
        </AlertDialogDescription>
      </AlertDialogHeader>
      <AlertDialogFooter>
