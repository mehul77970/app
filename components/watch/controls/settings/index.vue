...
<template>
  <DropdownMenu v-model:open="open" @update:open="updateContextMenuOpenState">
    <DropdownMenuTrigger as-child>
      <Button v-focus variant="ghost" size="icon" class="selectable">
        <PhGearSix :size="24" :weight="open ? 'fill' : 'regular'" />
      </Button>
    </DropdownMenuTrigger>
