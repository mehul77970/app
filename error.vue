...
onMounted(() => {
  l.$log({ type: "error", message: error.message, optionalParams: [error] });
});
</script>
...
<template>
  ...
  >
    ...
    <div class="flex flex-col gap-2 font-semibold mt-8">
      <Button size="lg" @click="refresh"> Refresh Page </Button>
      <Button variant="destructive" size="lg" @click="clearAndRefresh">
