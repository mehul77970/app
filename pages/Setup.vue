    ...
    <div class="max-w-[80%] flex flex-col gap-8 justify-center items-center">
      ...
      <div class="inline-flex flex-col gap-2">
        ...
        <div class="info inline-flex flex-col gap-2 mt-4">
          ...
          <p>NUXT_INTERNAL_SERVER_URL &lt;- Set this to your docker network<br>or internal LAN ip of the Jellyfin Server</p>
          <p>NUXT_PUBLIC_SERVER_URL &lt;- Set this to the URL you would like the client to use.<br>for example https://myjellyfinserver.com</p>
        </div>
      </div>
    </div>
  </div>
